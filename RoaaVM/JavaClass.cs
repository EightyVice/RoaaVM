...
namespace RoaaVirtualMachine
{
    ...
    public partial class JavaClass : KaitaiStruct
    {
        ...
        public partial class AttributeInfo : KaitaiStruct
        {
                    ...
                    case "LocalVariableTable":
                        {
                            __raw_info = m_io.ReadBytes(AttributeLength);
                            var io___raw_info = new KaitaiStream(__raw_info);
                            _info = new AttrLocalVariableTable(io___raw_info, this, m_root);
                            break;
                        }
            ...
            /// <remarks>
            /// Reference: <a href="https://docs.oracle.com/javase/specs/jvms/se8/html/jvms-4.html#jvms-4.7.13">Source</a>
            /// </remarks>
            public partial class AttrLocalVariableTable : KaitaiStruct
            {
                public static AttrLocalVariableTable FromFile(string fileName)
                {
                    return new AttrLocalVariableTable(new KaitaiStream(fileName));
                }

                public AttrLocalVariableTable(KaitaiStream p__io, JavaClass.AttributeInfo p__parent = null, JavaClass p__root = null) : base(p__io)
                {
                    m_parent = p__parent;
                    m_root = p__root;
                    _read();
                ...
                private void _read()
                {
                    _localVariableTableLength = m_io.ReadU2be();
                    _localVariableTable = new List<LocalVariableTableEntry>();
                    for (var i = 0; i < LocalVariableTableLength; i++)
                    {
                        _localVariableTable.Add(new LocalVariableTableEntry(m_io, this, m_root));
                    }
                }
                public partial class LocalVariableTableEntry : KaitaiStruct
                {
                    public static LocalVariableTableEntry FromFile(string fileName)
                    {
                        return new LocalVariableTableEntry(new KaitaiStream(fileName));
                    }

                    public LocalVariableTableEntry(KaitaiStream p__io, JavaClass.AttributeInfo.AttrLocalVariableTable p__parent = null, JavaClass p__root = null) : base(p__io)
                    {
                        m_parent = p__parent;
                        m_root = p__root;
                        f_nameIndexAsStr = false;
                        f_descriptorIndexAsStr = false;
                        _read();
                    }
                    private void _read()
                    {
                    ...
                    private bool f_nameIndexAsStr;
                    private string _nameIndexAsStr;
                    public string NameIndexAsStr
                    {
                        get
                        {
                            if (f_nameIndexAsStr)
                                return _nameIndexAsStr;
                            _nameIndexAsStr = (string)(((JavaClass.Utf8CpInfo)(M_Root.ConstantPool[(NameIndex - 1)].CpInfo)).Value);
                            f_nameIndexAsStr = true;
                            return _nameIndexAsStr;
                        }
                    }
                    private bool f_descriptorIndexAsStr;
                    private string _descriptorIndexAsStr;
                    public string DescriptorIndexAsStr
                    {
                        get
                        {
                            if (f_descriptorIndexAsStr)
                                return _descriptorIndexAsStr;
                            _descriptorIndexAsStr = (string)(((JavaClass.Utf8CpInfo)(M_Root.ConstantPool[(DescriptorIndex - 1)].CpInfo)).Value);
                            f_descriptorIndexAsStr = true;
                            return _descriptorIndexAsStr;
                        }
                    }
                    private ushort _startPc;
                    ...
                    private JavaClass m_root;
                    private JavaClass.AttributeInfo.AttrLocalVariableTable m_parent;
                    public ushort StartPc { get { return _startPc; } }
                    ...
                    public JavaClass M_Root { get { return m_root; } }
                    public JavaClass.AttributeInfo.AttrLocalVariableTable M_Parent { get { return m_parent; } }
                }
                private ushort _localVariableTableLength;
                private List<LocalVariableTableEntry> _localVariableTable;
                private JavaClass m_root;
                private JavaClass.AttributeInfo m_parent;
                public ushort LocalVariableTableLength { get { return _localVariableTableLength; } }
                public List<LocalVariableTableEntry> LocalVariableTable { get { return _localVariableTable; } }
                public JavaClass M_Root { get { return m_root; } }
                public JavaClass.AttributeInfo M_Parent { get { return m_parent; } }
            }
